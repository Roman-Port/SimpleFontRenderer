...
namespace RomanPort.SimpleFontRenderer.Generator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                ProcessPack(i, "RobotoMono-Regular.ttf", $"SYSTEM_REGULAR_{i}.sdrf");
                ProcessPack(i, "RobotoMono-Bold.ttf", $"SYSTEM_BOLD_{i}.sdrf");
            }
        }
        ...
        {
            //Log
            Console.WriteLine($"Rendering {outputName}...");
            ...
            byte[] buffer = new byte[Math.Max(actualHeight * actualWidth, Math.Max(FontPack.CHAR_HEADER_SIZE, FontPack.HEADER_SIZE))];
            ...
            output.Write(buffer, 0, FontPack.HEADER_SIZE);
            ...
            for (int i = 0; i < chars.Length; i++)
            {
                ...
                buffer[1] = 0;
                output.Write(buffer, 0, FontPack.CHAR_HEADER_SIZE);
